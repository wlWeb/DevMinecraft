...
public class ConfigGuiFactory implements IModGuiFactory {
	...
	public Class<ConfigGui> mainConfigGuiClass() {
		return ConfigGui.class;
	}

	/**
	 * Gets the runtime gui categories which change in game
	 */
	@Override
	...
	public static class ConfigGui extends GuiConfig {
		...
		public static class CategoryEntryBlocks extends CategoryEntry {
			...
			protected GuiScreen buildChildScreen() {
				...
				ConfigElement categoryBlocks = new ConfigElement(config.getCategory(ConfigHandler.CATEGORY_NAME_BLOCKS));
